...
Record result := {
result_figure1 := bigstep;
result_figure2 := satisfy;
result_figure3 := WPCSL;
result_figure4 := SPCSL;
result_lemma1 := store_substitution_lemma;
result_definition1 := asub_heap_update;
result_lemma2 := heap_update_substitution_lemma;
result_definition2 := asub_heap_clear;
result_lemma3 := heap_clear_substitution_lemma;
result_theorem1 := WPCSL_soundness_completeness;
result_theorem2 := SPCSL_soundness_completeness;
}.
